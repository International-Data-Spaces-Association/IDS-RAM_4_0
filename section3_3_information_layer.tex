...
\begin{figure}[H]
	\begin{Center}
		\includegraphics[width=2.0in,height=2.61in]{./media/image33.png}
          %% ToDo: instead of the image in this repository, please use Figure 3.4.3.5 from the Tab "RAM4.0" in https://drive.google.com/file/d/1ZMm2dZoCa_VQscNStVpthYkfbCPzlfTQ/view (Open with diagrams.net while logged in with Google), once Johannes Lipp has updated it.
...
\begin{figure}[H]
	\begin{Center}
		\includegraphics[width=1.33in,height=2.68in]{./media/image37.png}
          %% ToDo: instead of the image in this repository, please use Figure 3.4.3.6 from the Tab "RAM4.0" in https://drive.google.com/file/d/1ZMm2dZoCa_VQscNStVpthYkfbCPzlfTQ/view (Open with diagrams.net while logged in with Google), once Johannes Lipp has updated it.
...
\begin{figure}[H] 			
	\begin{Center}
		\includegraphics[width=1.46in,height=2.77in]{./media/image38.png}
          %% ToDo: instead of the image in this repository, please use Figure 3.4.3.7 from the Tab "RAM4.0" in https://drive.google.com/file/d/1ZMm2dZoCa_VQscNStVpthYkfbCPzlfTQ/view (Open with diagrams.net while logged in with Google), once Johannes Lipp has updated it.
...
\begin{figure}[H]
	\begin{Center}
		\includegraphics[width=1.36in,height=2.5in]{./media/image39.png}
          %% ToDo: instead of the image in this repository, please use Figure 3.4.3.8 from the Tab "RAM4.0" in https://drive.google.com/file/d/1ZMm2dZoCa_VQscNStVpthYkfbCPzlfTQ/view (Open with diagrams.net while logged in with Google), once Johannes Lipp has updated it.
...
\begin{figure}[H]
	\begin{Center}
		\includegraphics[width=1.34in,height=2.33in]{./media/image43.png}
          %% ToDo: instead of the image in this repository, please use Figure 3.4.3.9 from the Tab "RAM4.0" in https://drive.google.com/file/d/1ZMm2dZoCa_VQscNStVpthYkfbCPzlfTQ/view (Open with diagrams.net while logged in with Google), once Johannes Lipp has updated it.
...
\begin{figure}[H]
	\begin{Center}
		\includegraphics[width=1.36in,height=2.12in]{./media/image48.png}
          %% ToDo: instead of the image in this repository, please use Figure 3.4.3.10 from the Tab "RAM4.0" in https://drive.google.com/file/d/1ZMm2dZoCa_VQscNStVpthYkfbCPzlfTQ/view (Open with diagrams.net while logged in with Google), once Johannes Lipp has updated it.
...
\begin{figure}[H]
	\begin{Center}
          ...
          %% ToDo: instead of the image in this repository, please use Figure 3 30 from the Tab "RAM4.0" in https://drive.google.com/file/d/1ZMm2dZoCa_VQscNStVpthYkfbCPzlfTQ/view (Open with diagrams.net while logged in with Google), once Johannes Lipp has updated it.
