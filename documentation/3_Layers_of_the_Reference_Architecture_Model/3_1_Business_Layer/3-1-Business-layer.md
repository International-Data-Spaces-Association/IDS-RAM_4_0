...
## Functional Layer {#sec_functional_layer}
...
Spaces](./media/image21.png){#fig:_Functional_architecture_of_the_International_Data_Spaces
width="6.44in" height="2.78in"}
:::

Figure
[4](#fig:_Functional_architecture_of_the_International_Data_Spaces){reference-type="ref"
reference="fig:_Functional_architecture_of_the_International_Data_Spaces"}
...
[\[subsec:Goals_of_IDS\]](#subsec:Goals_of_IDS){reference-type="ref"
reference="subsec:Goals_of_IDS"}.
