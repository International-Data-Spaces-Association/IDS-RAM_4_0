...
<li> The Vocabulary Hub shall provide creating, selectio, editing (inserting, updating, changing, deleting, matching, version management), read- and search functionalities and supports SPARQL queries.
