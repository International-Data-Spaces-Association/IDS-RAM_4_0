...
2. The contract shall specify at least the following:
  ...
  * d. the evaluation contract (scope of the evaluation, location of the evaluation, planned evaluation duration, evaluation report) including a statement of the certification level applied for by the applicant;
...
2. The contract shall specify at least the following:
  ...
  * e. the certification application including details of the certification level applied for;
